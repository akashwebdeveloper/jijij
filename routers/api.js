...
const { testing, Squad, upcoming, upcome, liveMatchRank, shortScoreBoard, fullScoreBoard } = require('../controller/matches/matchAPI')   
const { openContestList, createTeam, teamList, joinContest, updateTeam, contestDetails, joinedContest, joinedMatches } = require('../controller/matches/contest')   
...
router.get('/upcome', upcome)
router.post('/live_match_rank', liveMatchRank)
router.post('/short_score_board', shortScoreBoard)
router.post('/full_score_board', fullScoreBoard)
...
router.post('/joined_contest', joinedContest)
router.post('/joined_matches', joinedMatches)
