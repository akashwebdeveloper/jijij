...
<div class="winner">
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <div class="form-line">
                                        <input type="number" name="from" class="form-control" placeholder="Ex: 2" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-md-offset-1">
                                <div class="input-group">
                                    ...
                                    <div class="form-line">
                                        <input type="number" name="to"  class="form-control" placeholder="Ex: 2" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-md-offset-1">
                                <div class="input-group">
                                    ...
                                    <div class="form-line">
                                        <input type="number" name="ammount"  class="form-control" placeholder="Ex: 2" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-1">
                                    <a href="#" class="remove-lnk" alt="Remove" style="cursor: pointer;"
